...
import "engine/pages"
import "engine/components" as Components
import "engine/GameEngine.js" as Engine

ApplicationWindow {
    initialPage:            Component { GameScreen { } }            // Put the GameScreen as the root of the PageStack
    cover:                  Qt.resolvedUrl("engine/cover/CoverPage.qml")   // GameScreen will not be our first page, but having
    ...
    Component.onCompleted: {
        ...
        Engine.setEngineDefaultsPath(Qt.resolvedUrl("engine/engine_defaults")) // Setting path for engine defaults
        ...
        pageStack.push(Qt.resolvedUrl("engine/pages/TitlePage.qml"), {gameScreen: game}, PageStackAction.Immediate)
    }
}
